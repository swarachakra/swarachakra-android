...
public class MainLanguage extends Language{
	...
	public MainLanguage() {
		...
		defaultChakra = new String[] {"\u0c4d", "\u0c3e", "\u0c3f", "\u0c40", "\u0c41", "\u0c42", "\u0c46", "\u0c47", "\u0c4a", "\u0c4b"};
		halantExists =  true;
		halantEnd = 35;
...
KeyAttr myKey35 = new KeyAttr();
	...
	myKey35.customChakraLayout = new String[] {"\u0c06","\u0c07","\u0c08","\u0c09","\u0c0a","\u0c0e","\u0c0f","\u0c12","\u0c13"} ;
...
KeyAttr myKey36 = new KeyAttr();
	...
	myKey36.customChakraLayout = new String[] {"\u0c4d","\u0c3e","\u0c3f","\u0c40","\u0c41","\u0c42","\u0c46","\u0c47","\u0c4a","\u0c4b"} ;
